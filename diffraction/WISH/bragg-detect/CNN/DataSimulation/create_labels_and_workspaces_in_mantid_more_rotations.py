...
axis1_rotations = [f"{angle},1,1,0,1" for angle in range(-10, 11, 5)]

for rot_0_i, rot_0 in enumerate(axis0_rotations):
    for rot_1_i, rot_1 in enumerate(axis1_rotations): 
        cloned_ws = ws.clone()
        SetGoniometer(cloned_ws, Axis0=rot_0, Axis1=rot_1)
        # predict peaks
        ...
        frac_cutoff = 0.01  # cutoff in integrated intensity used to find peak extents for labelling
        ...
        labels_path = r"/home/wj1132075/Desktop/Raw_increased_range02/Labels/labels_{}_{}.txt".format(rot_0_i, rot_1_i)
        np_ws_path = r"/home/wj1132075/Desktop/Raw_increased_range02/Workspaces/workspace_{}_{}.npz".format(rot_0_i, rot_1_i)
