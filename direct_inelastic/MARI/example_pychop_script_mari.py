...
from PyChopMARI_CalibWB import *
...
title('MARI Ei = '+str(Ei)+' meV, freq = '+str(freq)+' A-chopper')
...
title('MARI flux vs Ei, freq = '+str(freq)+' G-chopper')
...
title('MARI resolution vs Ei, freq = '+str(freq)+' G-chopper')
xlabel('Incident energy (meV)')
