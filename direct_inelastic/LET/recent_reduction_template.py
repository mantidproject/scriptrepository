...
#---------------------------------------------------------------------------#
      # multiple energies provided in the data file
       ...
       prop['sample_run'] = range(18547,18633)
...
#------------------------------------------------------------------------------------#
   ...
   def def_advanced_properties(self):
      ...
      prop['hardmaskOnly']='hard_2014_3_9Tmagnet_0to90.msk' # diag does not work well on LET. At present only use a hard mask RIB has created
      ...
      # THERE IS CURRENTLY BUG IN loadISISNexus, which does not load monitors separately
      # when bug is fixed, this value should be irrelevant. Put true for histogram nexus. 
...
#------------------------------------------------------------------------------------#
   ...
   def set_custom_output_filename(self):
      ...
      def custom_name(prop_man):
          ...
          name = "LET{0}_{1:<3.2f}meV_Web".format(run_num ,ei)
          return name
