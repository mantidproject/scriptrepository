...
###########################################################################################
red_settings = FileFinder.getFullPath('settings_csv_5861.csv')
...
index_files_to_reduce = "4-13,24"  # as per csv_files_to_reduce_list file - LINES' INDEXES FOR FILES TO BE REDUCED
