...
initguess = { 'f0.f1.f0.Height' :    0.1,   # intensity fraction due to elastic line
              ...
              'f0.f1.f1.Tau'    : 1000.0,   # relaxation time
              'f0.f1.f1.Beta'   :    0.9,   # stretching exponent
              'f1.A0'           :    0.0,   # intercept of linear background
              'f1.A1'           :    0.0,   # slope of linear background
...
def sequentialFit(resolution, data, background, fitstring_template, initguess, erange, qvalues, selected_wi):
    """
