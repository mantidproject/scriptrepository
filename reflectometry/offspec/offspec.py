...
#===========================================================
#
def nrPNRFn(runList,nameList,incidentAngles,DBList,specChan,minSpec,maxSpec,gparams,floodfile,PNRwithPA,pnums,doCorrs,doLDCorrs="0",subbgd=0,calibration=0,usewkspname=0,dofloodnorm=True,diagnostics=0):
    nlist=parseNameList(nameList)
    logger.notice("This is the sample nameslist:"+str(nlist))
    if(usewkspname==0):
        rlist=parseRunList(runList)
